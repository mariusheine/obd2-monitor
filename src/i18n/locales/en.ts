...
const en = {
  ...
  settings: {
    title: 'Cloud sync',
    intro:
      'Upload recorded sessions to a folder on your own Nextcloud so everyone driving the car pools their data. Uses a Nextcloud username and app password (see the setup guide).',
    ...
    urlOk: 'Server: {host}',
    username: 'Username',
    usernamePlaceholder: 'e.g. car-obd',
    ...
    folderHelp: 'Created automatically if it doesn’t exist. Sub-folders allowed (e.g. car/obd).',
